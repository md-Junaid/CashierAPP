        ...
        >
          <CardContent>
            <ThemedText type="defaultSemiBold">
              <Text style={{ color: "#8ddcf2" }}>
                {value.length === 0 ? "___________" : value}
              </Text>{" "}
            ...
            >
              <ThemedText type="defaultSemiBold" style={{ color: "#00b253" }}>
                Total:
              </ThemedText>
              <ThemedText type="defaultSemiBold" style={{ color: "#00b253" }}>
          ...
          >
            <View style={{ flexDirection: "row", flexWrap: "wrap" }}>
              ...
              <Button
                style={{
                  backgroundColor:
                    selectedItems.length === 0 || value.length === 0
                      ? "grey"
                      : "#00b253",
                  borderRadius: 10,
                  borderRadius: 15,
          ...
          {allOrders
            ...
            .map((order, index) => (
              ...
              >
                <CardContent>
                  <ThemedText type="defaultSemiBold">
                    <Text style={{ color: "#8ddcf2" }}>{order.customer}</Text>{" "}
            ...
            .map((order, index) => (
              ...
              >
                ...
                >
                  ...
                  >
                    Paid on: {convertUnixTime(order.time)}
                  </ThemedText>
                  <Button
